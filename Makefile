...
ICONNAME = images/icon_xcash_blue.gif
else
ICONNAME = images/icon_xcash.gif
endif
...
DEFINES   += $(XCASH_CONFIG) XCASH_VERSION=$(APPVERSION) XCASH_NAME=$(APPNAME) SPEC_VERSION=$(SPECVERSION)
