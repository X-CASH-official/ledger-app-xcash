...
#ifndef XCASH_TYPES_H
#define XCASH_TYPES_H
 ...
 */
#define XCASH_APDU_LENGTH                       0xFE


/* big private DO */
#define XCASH_EXT_PRIVATE_DO_LENGTH             512
/* will be fixed..1024 is not enougth */
#define XCASH_EXT_CARD_HOLDER_CERT_LENTH        2560
/* random choice */
#define XCASH_EXT_CHALLENGE_LENTH               254

/* --- ... --- */
#define MAINNET_CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX             0x5c134
#define MAINNET_CRYPTONOTE_PUBLIC_INTEGRATED_ADDRESS_BASE58_PREFIX  0x3fc134
...
typedef struct xcash_nv_state_s xcash_nv_state_t;

#define XCASH_IO_BUFFER_LENGTH (300)
enum device_mode {
  NONE,
...
struct xcash_v_state_s {
  ...
  unsigned char   io_buffer[XCASH_IO_BUFFER_LENGTH];
...
typedef struct  xcash_v_state_s xcash_v_state_t;




#define SIZEOF_TX_VSTATE   (sizeof(xcash_v_state_t) - OFFSETOF(xcash_v_state_t, state))
